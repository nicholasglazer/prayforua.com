export default {
  en: {
    ...
    'user.project.editState':
      'Projects configurations will be saved automatically!',
    'user.project.name': 'Project title',
    'user.project.description': 'Project description',
    'user.project.country': 'Project country',
    'user.project.city': 'Project city',
    ...
    'user.createProject.goal':
      'Your charity goal in Flow currency (cannot be changed later)',
    'user.navTitle': 'Account navigation',
    'user.settings.connectWallet': 'Connect flow wallet',
    'user.settings.pageDescription': 'Use general settings',
